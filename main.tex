...
%     \hline
    Criteria & \rotatebox{\myvar}{RGB cam} & \rotatebox{\myvar}{Depth cam} & \rotatebox{\myvar}{Wearable} & \rotatebox{\myvar}{Acoustic} & \rotatebox{\myvar}{Radar / Wi-Fi} & \rotatebox{\myvar}{Vibration} & \rotatebox{\myvar}{Floor} \\
    \midrule
    ...
    Robustness & \onslide<2->{\starb\starb\starw & \starb\starb\starb} & \starb\starb\starb & \starb\starw\starw & \starb\starw\starw & \starb\starw\starw & \starb\starb\starw \\
    Ease of instal. / use & \onslide<2->{\starb\starw\starw & \starb\starw\starw} & \starb\starb\starw & \starb\starb\starw & \starb\starb\starw & \starb\starb\starb & \starb\starw\starw \\
    Scalability & \onslide<2->{\starb\starw\starw & \starb\starw\starw} & \starb\starb\starb & \starb\starb\starw & \starb\starw\starw & \starb\starb\starw & \starb\starb\starb \\
    \midrule
    \end{tabular}
