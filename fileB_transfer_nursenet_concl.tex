...
\begin{frame}{Transfer learning on decision tree}{Data}
...
\begin{frame}{Transfer learning on decision tree}{Results}
...
%         \centering
        \begin{minipage}[t]{0.33\linewidth}\vspace{0pt}
            \centering
            \begin{minipage}[t]{\ratio\linewidth}\vspace{0pt}
            \centerline{\includegraphics[width=\linewidth, trim={0 0 0 0}, clip]{SER_ll_05_DataSYNTH_Source_D_3_C_10_N_200_Target_drift_deg_5_Scorefilescores_2020_02_22_BALANCESOURCE50_KFOLD_NTARGET150_NB_TREE1_BarPlot_AUC_depthNone.pdf}}
            \end{minipage}\\
            \begin{minipage}[t]{\ratio\linewidth}\vspace{0cm}
            \centerline{\includegraphics[width=\linewidth, trim={0 0 0 0}, clip]{STRUT_DataSYNTH_Source_D_3_C_10_N_200_Target_drift_deg_5_Scorefilescores_2020_02_22_BALANCESOURCE50_KFOLD_NTARGET150_NB_TREE1_BarPlot_AUC_depthNone.pdf}}
            \end{minipage}\\
            \medskip
            {\small(a)\; Drift}
        \end{minipage}
        \begin{minipage}[t]{0.33\linewidth}\vspace{0pt}
            \centering
            \begin{minipage}[t]{\ratio\linewidth}\vspace{0pt}
            \centerline{\includegraphics[width=\linewidth, trim={0 0 0 0}, clip]{SER_ll_05_DataSYNTH_Source_D_3_C_10_N_200_Target_std_deg_9_Scorefilescores_2020_02_19_3_synth_BALANCESOURCE50_KFOLD_NTARGET150_NB_TREE1_BarPlot_AUC_depthNone.pdf}}
            \end{minipage}\\
            \begin{minipage}[t]{\ratio\linewidth}\vspace{0cm}
            \centerline{\includegraphics[width=\linewidth, trim={0 0 0 0}, clip]{STRUT_DataSYNTH_Source_D_3_C_10_N_200_Target_std_deg_9_Scorefilescores_2020_02_19_3_synth_BALANCESOURCE50_KFOLD_NTARGET150_NB_TREE1_BarPlot_AUC_depthNone.pdf}}
            \end{minipage}\\
            \medskip
        ...
        \begin{minipage}[t]{0.33\linewidth}\vspace{0pt}
            \centering
            \begin{minipage}[t]{\ratio\linewidth}\vspace{0pt}
            \centerline{\includegraphics[width=\linewidth, trim={0 0 0 0}, clip]{SER_ll_05_DataSYNTH_Source_D_3_C_10_N_200_Target_add_remove_deg_0_Scorefilescores_2020_02_20_2_synth_BALANCESOURCE50_KFOLD_NTARGET150_NB_TREE1_BarPlot_AUC_depthNone.pdf}}
            \end{minipage}\\
            \begin{minipage}[t]{\ratio\linewidth}\vspace{0cm}
            \centerline{\includegraphics[width=\linewidth, trim={0 0 0 0}, clip]{STRUT_DataSYNTH_Source_D_3_C_10_N_200_Target_add_remove_deg_0_Scorefilescores_2020_02_20_2_synth_BALANCESOURCE50_KFOLD_NTARGET150_NB_TREE1_BarPlot_AUC_depthNone.pdf}}
            \end{minipage}\\
            \medskip
            {\small(c)\; Add / Remove}
        \end{minipage}
...
\renewcommand{\ratio}{1.0}
        ...
        \begin{minipage}[t]{0.33\linewidth}\vspace{0pt}
            \centering
            \begin{minipage}[t]{\ratio\linewidth}\vspace{0pt}
            \centerline{\includegraphics[width=\linewidth, trim={0 0 0 0}, clip]{SER_ll_05_Datamagic_gamma_telescope_Scorefilescores_2020_02_17_2_BALANCESOURCE50_KFOLD5_NTARGET_NB_TREE1_BarPlot_AUC_depthNone.pdf}}
            \end{minipage}\\
            \begin{minipage}[t]{\ratio\linewidth}\vspace{0cm}
            \centerline{\includegraphics[width=\linewidth, trim={0 0 0 0}, clip]{STRUT_Datamagic_gamma_telescope_Scorefilescores_2020_02_17_2_BALANCESOURCE50_KFOLD5_NTARGET_NB_TREE1_BarPlot_AUC_depthNone_ig.pdf}}
            \end{minipage}\\
            \medskip
        ...
        \begin{minipage}[t]{0.33\linewidth}\vspace{0pt}
            \centering
            \begin{minipage}[t]{\ratio\linewidth}\vspace{0pt}
            \centerline{\includegraphics[width=\linewidth, trim={0 0 0 0}, clip]{SER_ll_05_Dataoffice_caltech_am_webcam_Scorefilescores_2020_02_17_8_BALANCESOURCE50_KFOLD5_NTARGET_NB_TREE1_BarPlot_AUC_depthNone.pdf}}
            \end{minipage}\\
            \begin{minipage}[t]{\ratio\linewidth}\vspace{0cm}
            \centerline{\includegraphics[width=\linewidth, trim={0 0 0 0}, clip]{STRUT_Dataoffice_caltech_am_webcam_Scorefilescores_2020_02_17_8_BALANCESOURCE50_KFOLD5_NTARGET_NB_TREE1_BarPlot_AUC_depthNone_ig.pdf}}
            \end{minipage}\\
            \medskip
        ...
        \begin{minipage}[t]{0.329\linewidth}\vspace{0pt}
            \centering
            \begin{minipage}[t]{\ratio\linewidth}\vspace{0pt}
            \centerline{\includegraphics[width=\linewidth, trim={0 0 0 0}, clip]{SER_ll_05_Dataoffice_caltech_cal_webcam_Scorefilescores_2020_02_17_8_BALANCESOURCE50_KFOLD5_NTARGET_NB_TREE1_BarPlot_AUC_depthNone.pdf}}
            \end{minipage}\\
            \begin{minipage}[t]{\ratio\linewidth}\vspace{0cm}
            \centerline{\includegraphics[width=\linewidth, trim={0 0 0 0}, clip]{STRUT_Dataoffice_caltech_cal_webcam_Scorefilescores_2020_02_17_8_BALANCESOURCE50_KFOLD5_NTARGET_NB_TREE1_BarPlot_AUC_depthNone_ig.pdf}}
            \end{minipage}\\
            \medskip
...
\renewcommand{\ratio}{0.65}
    \begin{minipage}[t]{0.49\linewidth}\vspace{0pt}
        \centering
        \begin{minipage}[t]{\ratio\linewidth}\vspace{0pt}
        \centerline{\includegraphics[width=\linewidth]{SER_ll_05_Datatarkett_transfer_db_all_c_all_Scorefilescores_2020_01_15_bis__NB_TREE1_AUC_of_kfold__depthNone_nbtree1.pdf}}
        \end{minipage}\\
        \begin{minipage}[t]{\ratio\linewidth}\vspace{0cm}
        \centerline{\includegraphics[width=\linewidth]{STRUT_Datatarkett_transfer_db_all_c_all_Scorefilescores_2020_01_15_bis__NB_TREE1_AUC_of_kfold__depthNone_nbtree1.pdf}}
        \end{minipage}\\
%         \medskip
    ...
    \begin{minipage}[t]{0.49\linewidth}\vspace{0pt}
        \centering
        \begin{minipage}[t]{\ratio\linewidth}\vspace{0pt}
        \centerline{\includegraphics[width=\linewidth]{SER_ll_05_Datatarkett_transfer_db_all_c_all_Scorefilescores_2020_04_02__NB_TREE10_AUC_of_kfold__depthNone_nbtree10.pdf}}
        \end{minipage}\\
        \begin{minipage}[t]{\ratio\linewidth}\vspace{0cm}
        \centerline{\includegraphics[width=\linewidth]{STRUT_Datatarkett_transfer_db_all_c_all_Scorefilescores_2020_04_02__NB_TREE10_AUC_of_kfold__depthNone_nbtree10.pdf}}
        \end{minipage}\\
%         \medskip
...
\renewcommand{\ratio}{1.00}
    \begin{overprint}
        \onslide<2>\centering\includegraphics[width=\ratio\linewidth]{Mercredi_10_19_13_00_to_10_19_18_85_th_005.pdf}
        \onslide<3>\centering\includegraphics[width=\ratio\linewidth]{Mercredi_10_19_13_00_to_10_19_18_85_th_02.pdf}
        \onslide<4>\centering\includegraphics[width=\ratio\linewidth]{Mercredi_10_19_13_00_to_10_19_18_85_th_03.pdf}
    \end{overprint}
\end{minipage}
\end{frame}
