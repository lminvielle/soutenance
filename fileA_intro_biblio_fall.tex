...
%             \item \textbf{Objective}: 
        \end{itemize}
            \smallskip
            \onslide<2->\includegraphics[width=0.4\linewidth]{FIM.jpg}\\[2pt]
            \onslide<2->\includegraphics[width=0.95\linewidth]{schema_fall_detector.pdf}\\
    \pause \pause
\end{minipage}\hfill
...
%     \bigskip
        ...
        \begin{minipage}[t]{0.9\linewidth}
            \vspace{0.5pt}
            \centering
            \onslide<4->\includegraphics[width=0.7\linewidth]{signal_marche_accelerometre_left_right_epure.pdf}\\
        ...
        \begin{minipage}[t]{0.9\linewidth}
            \vspace{0pt}
            \centering
            \onslide<4->\includegraphics[width=0.75\linewidth]{signal_marche_tarkett_epure.pdf}\\
...
%             \onslide<4>\includegraphics[width=\linewidth, trim={190 50 150 20}, clip]{fall_systems_1_3-14.pdf}
            \onslide<1>\includegraphics[width=\linewidth, trim={190 50 150 60}, clip]{fall_systems_2-14.pdf}
            \onslide<2>\includegraphics[width=\linewidth, trim={190 50 150 60}, clip]{fall_systems_3-14.pdf}
        \end{overprint}
    \end{minipage}
% \end{minipage}
\end{frame}
...
\end{minipage}
    \pause
    \centering
    \includegraphics[width=0.51\textwidth]{ex_signal_chute_2.pdf}
...
\begin{frame}{Method}{Time aggregation}
...
\begin{frame}{Methods}{Time aggregation}
